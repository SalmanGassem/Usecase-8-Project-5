...
if selected == "Home":
    ...
    st.write("In this chart, the distribution of subscribers' levels is shown according to the course type. We observe that beginners have the highest subscription rate across all types.")
   
   
    st.image("img/chart10.png")
    st.write("Here, we can see the distribution of course durations, with courses lasting 1-4 weeks receiving the highest percentage.")
    st.image("img/chart11.png")
    st.write("Here, we present the top ten providers and the types of courses they offer. It is noticeable that universities do not offer professional certificates.")
